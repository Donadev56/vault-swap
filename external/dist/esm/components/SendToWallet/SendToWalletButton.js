  ...
  return _jsx(Collapse, {
    ...
    children: _jsxs(
      ...
      // biome-ignore lint/a11y/useSemanticElements:
      {
        ...
        children: [
          _jsx(CardTitle, { required: requiredToAddress, children: title }),
          _jsx(Box, {
            sx: {
              display: "flex",
            ...
            children: _jsx(SendToWalletCardHeader, {
              avatar: _jsx(AccountAvatar, {
                chainId: chainId,
              ...
              action:
                !!toAddressFieldValue && !disabledForChanges
                  ? _jsx(CardIconButton, {
                      ...
                      size: "small",
                      children: _jsx(CloseRounded, { fontSize: "inherit" }),
                    })
                  : null,
            }),
          }),
