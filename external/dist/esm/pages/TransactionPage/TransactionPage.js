  ...
  return _jsxs(PageContainer, {
    ...
    children: [
      ...
      subvariant === "custom" && contractSecondaryComponent
        ...
        : null,
      _jsx(TransactionDetails, { route: route, sx: { marginTop: 2 } }),
      status === RouteExecutionStatus.Idle ||
      status === RouteExecutionStatus.Failed
        ? _jsxs(_Fragment, {
            children: [
              _jsx(WarningMessages, {
                mt: 2,
                route: route,
        ...
        : null,
      status ? _jsx(StatusBottomSheet, { status: status, route: route }) : null,
      subvariant !== "custom"
        ? _jsx(TokenValueBottomSheet, {
            route: route,
            ref: tokenValueBottomSheetRef,
            onContinue: handleExecuteRoute,
          })
        : null,
      _jsx(ExchangeRateBottomSheet, { ref: exchangeRateBottomSheetRef }),
      _jsx(ConfirmToAddressSheet, {
