...
`;
export const createTheme = (widgetTheme = {}) => {
  ...
  const primaryMainColorLight =
    configuredPaletteLight?.primary?.main ?? palette.primary.main;
  const primaryMainColorDark =
    configuredPaletteDark?.primary?.main ?? palette.primary.main;
  ...
  const secondaryMainColorLight =
    configuredPaletteLight?.secondary?.main ?? palette.secondary.main;
  const secondaryMainColorDark =
    configuredPaletteDark?.secondary?.main ?? palette.secondary.main;
